...
export const treeVariants = cva('flex flex-col text-sm h-full', {
  variants: {},
  defaultVariants: {},
});
...
export const treeNodeContentVariants = cva(
  'flex flex-1 items-center gap-1.5 rounded-sm px-2 py-1 text-sm cursor-pointer select-none transition-colors hover:bg-accent/50 hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring',
  {
    variants: {
      isSelected: {
